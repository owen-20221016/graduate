...
public class AddTakeOutAction extends ActionSupport {
	// username属性用来封装用户名
	private String name;
	...
	public String execute() throws Exception {
		...
		if (this.name.equals("") || this.prise.equals("") || this.discription.equals("") || this.myFileFileName.equals("")) {
			request.getSession().setAttribute("addmsg", "can not be null");
			return ERROR;
		}
		...
		takeout.setImg("img/" + myFileFileName);
		takeout.setName(name);
		takeout.setNum(0);
		takeout.setPrise(Double.parseDouble(prise));
		takeout.setSellnum(0);
		takeout.setDescription(discription);
