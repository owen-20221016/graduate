	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<%
					List<OrderBean> orderBeans = (List<OrderBean>) request.getAttribute("ordersList");
									...
									<td class=""><div>
											<p style="margin-bottom: 3px;">
												<span class="text-mod__link___2QaZ1"><a
													class="btn btn-success btn-sm" href="#">已收货</a></span>
											</p>
											<div>
												<p style="margin-bottom: 3px;"></p>
												<p style="margin-bottom: 3px;"></p>
						...
						<table
							...
							<tbody>
								<tr>
									...
									<td class=""><div>
											<p style="margin-bottom: 3px;">
												<a class="btn btn-warning btn-sm" href="orderctrl.action?userid=<%=orderBeans.get(a).getUserid()%>&orderNumber=<%=orderBeans.get(a).getOrderNumber()%>&mark=2&location=back">点击发货</a>
											</p>
										</div></td>
								</tr>
								<tr>
									...
									<td class="sol-mod__no-bt___3KjSb"></td>
									<td class="sol-mod__no-bt___3KjSb"></td>
									<td class="sol-mod__no-bt___3KjSb"><a href="delete.action?action=orders&id=<%=orderBeans.get(a).getUserid()%>&location=back&orderid=<%=orderBeans.get(a).getOrderNumber()%>">删除</a></td>
								</tr>
							</tbody>
						</table>
					</div>
